        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrierungsDatum = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Beschreibung = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    BildUrl = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BestellDatum = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    GesamtBetrag = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    LieferAdresse = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Stadt = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Postleitzahl = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    Land = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BildUrl = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    IstVerfuegbar = table.Column<bool>(type: "INTEGER", nullable: false),
                    ErstellungsDatum = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Anzahl = table.Column<int>(type: "INTEGER", nullable: false),
                    HinzugefuegtAm = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "datetime('now')"),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    ProductId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
